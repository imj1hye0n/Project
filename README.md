...
> 특히 AI 분야에 큰 관심을 가지고 있어, 관련 기술과 지식을 꾸준히 탐구하고 있습니다. 대학 생활 2년 동안 개발에 대한 지식을 배우며, 마지막 학년인 2학년 때는 학술제를 통해 결과물을 만든 경험도 있습니다. 또한, 2개월간 팀원으로서 팀 프로젝트를 진행하여 프론트엔드 개발자 역량을 길렀고, 내가 이해한 내용을 다른 사람들에게 설명하며 함께 성장할 수 있도록 영상을 통해 기록했습니다.
